...
document.addEventListener('contextmenu', function(e) {
  e.preventDefault();
  alert("Oops! You can't right-click.\u{1F6AB} If you need anything, just ask ROB.\u{1F60E}");
});
...
document.addEventListener('keydown', function(e) {
  if (e.key === "F12" || 
      ...
      (e.ctrlKey && e.key === "U")) {
    e.preventDefault();
    alert("Inspection blocked \u{1F6AB} Get in touch with ROB if you need anything.");
  }
});
...
(function(){
    ...
    canvasData.push({
        wrapper: get("wrapper"),
        colours: ["E80C7A", "FF0DFF", "E82C0C", "7C0000"],
        numParticles: 100,
        width: 1920,
        height: 1080,
        speed: 1
